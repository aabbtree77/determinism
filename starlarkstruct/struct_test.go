...
import (
	...
	"github.com/aabbtree77/determinism/starlarkstruct"
...
func (sym *symbol) Call(thread *starlark.Thread, args starlark.Tuple, kwargs []starlark.Tuple) (starlark.Value, error) {
	if len(args) > 0 {
